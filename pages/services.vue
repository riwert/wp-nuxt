...
export default {
  head() {
    return {
      title: 'Services Nuxt App',
      meta: [
        { hid: 'description', name: 'description', content: 'This is my services description here.'},
        { hid: 'keywords', name: 'keywords', content: 'services, nuxt, app'},
      ]
    }
  }
}
